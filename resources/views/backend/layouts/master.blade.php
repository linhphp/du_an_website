    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <div class="mb-container">
                <div class="mb-middle">
                    <div class="mb-title"><span class="fa fa-sign-out"></span><strong>@lang('language.sign_out') </strong> ?</div>
                    ...
                    <div class="mb-footer">
                        <div class="pull-right">
                            <form action="{{ route('logout.admin.post') }}" method="post">
                                @csrf
                                <button type="submit" class="btn btn-success btn-lg">@lang('language.yes') </button>
                                <button class="btn btn-default btn-lg mb-control-close">@lang('language.no')</button>
